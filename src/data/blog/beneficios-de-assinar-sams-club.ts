...
export const beneficiosDeAssinarSamsClub: BlogPost = {
  ...
  metaTitle: 'Sam\'s Club: Benefícios da Assinatura e Cupom de Boas-Vindas | Compare Ofertas',
  metaDescription:
    'O que é o Sam\'s Club, quanto custa a assinatura e como ganhar até R$ 75 de desconto na primeira compra como novo sócio — nas lojas físicas ou no site.',
  keyword: 'vale a pena assinar sam\'s club',
  secondaryKeywords: ['assinatura sam\'s club', 'sócio sam\'s club desconto', 'cupom sam\'s club primeira compra'],
  ...
  blocks: [
    ...
    { type: 'h2', text: 'Quanto custa ser sócio' },
    {
      type: 'ul',
      items: [
        'Sócio Club (plano base): R$ 95 por ano — e você recebe R$ 95 em crédito de volta pra usar na próxima compra em loja física, ou seja, a taxa se paga sozinha',
        'Sócio Plus (plano premium): R$ 175 por ano — inclui frete grátis, cashback turbinado, cupom de aniversário e descontos exclusivos em parcerias',
        'Cartão adicional grátis pra compartilhar o benefício com mais uma pessoa do mesmo endereço',
    ...
    { type: 'h2', text: 'Desconto de R$ 75 na primeira compra em loja física' },
    {
      type: 'ul',
      items: [
        ...
        'Só em lojas físicas',
        'Exclusivo pra CPF que ainda não está cadastrado na base do Sam\'s Club — ou seja, só pra quem nunca foi sócio antes',
  ...
  faq: [
    {
      q: 'Dá pra usar os dois descontos, o de R$ 50 e o de R$ 75?',
      a: 'Não — um é pra primeira compra no site/app (R$ 50, com o cupom BEMVINDO50) e o outro pra primeira compra em loja física (R$ 75). São canais diferentes, cada um com sua própria condição de valor mínimo.',
    },
    {
      q: 'A taxa de sócio vale a pena?',
      a: 'No plano base (R$ 95/ano), você recebe os mesmos R$ 95 de volta em crédito pra próxima compra em loja física — na prática, a anuidade se paga sozinha nesse primeiro ano.',
    },
    {
      q: 'Quem pode virar sócio do Sam\'s Club?',
      a: 'Qualquer pessoa física maior de 18 anos, ou pessoa jurídica (empresa).',
    },
    {
      q: 'O desconto de loja física funciona pra quem já foi sócio antes?',
      a: 'Não — é exclusivo pra CPF que ainda não está na base de cadastro do Sam\'s Club, ou seja, só pra quem nunca teve assinatura antes.',
    },
  ],
}
